...
Function SetISOFileName ; $DistroName $ISOFileName $DownLink $Persistence $DistroPath $Homepage $OfficialName
 ...
 !insertmacro SetISOFileNames "Ubuntu" "ubuntu-*.iso" "https://www.ubuntu.com/download" "casper" "Linux-ISOs" "https://ubuntu.com" "Ubuntu"
 !insertmacro SetISOFileNames "Ubuntu Server" "ubuntu-*-server-*.iso" "https://www.ubuntu.com/download/server" "NULL" "Linux-ISOs" "https://ubuntu.com/server" "Ubuntu Server"
 !insertmacro SetISOFileNames "Kubuntu" "kubuntu-*.iso" "https://kubuntu.org/getkubuntu/" "casper" "Linux-ISOs" "https://kubuntu.org/" "Kubuntu"
 !insertmacro SetISOFileNames "Lubuntu" "lubuntu-*.iso" "https://lubuntu.me/downloads/" "casper" "Linux-ISOs" "https://lubuntu.me/" "Lubuntu"
 !insertmacro SetISOFileNames "Xubuntu" "xubuntu-*.iso" "https://cdimage.ubuntu.com/xubuntu/releases/" "casper" "Linux-ISOs" "https://xubuntu.org" "Xubuntu"
 !insertmacro SetISOFileNames "Ubuntu Budgie" "ubuntu-budgie-*.iso" "https://ubuntubudgie.org/downloads" "casper" "Linux-ISOs" "https://ubuntubudgie.org/" "Ubuntu Budgie"
 !insertmacro SetISOFileNames "Ubuntu Mate" "ubuntu-mate-*.iso" "https://ubuntu-mate.org/download/" "casper" "Linux-ISOs" "https://ubuntu-mate.org/" "Ubuntu Mate"
 ...
 !insertmacro SetISOFileNames "Linux Mint Debian" "lmde-*.iso" "https://www.linuxmint.com/download_lmde.php" "live" "Linux-ISOs" "https://www.linuxmint.com" "Linux Mint"

     !insertmacro SetISOFileNames "" "" "" "" "" "" ""
     !insertmacro SetISOFileNames "--- CentOS ---" "" "" "" "" "" ""
	 !insertmacro SetISOFileNames "" "" "" "" "" "" ""

 !insertmacro SetISOFileNames "CentOS" "CentOS*.iso" "https://www.centos.org/download/" "NULL" "Linux-ISOs" "https://www.centos.org" "CentOS"
 ...
 !insertmacro SetISOFileNames "Debian Live" "debian-live-*.iso" "https://cdimage.debian.org/cdimage/release/current-live/amd64/iso-hybrid/" "live" "Linux-ISOs" "https://www.debian.org" "Debian Live"
 ...
 !insertmacro SetISOFileNames "OpenSUSE" "openSUSE*.iso" "https://get.opensuse.org" "NULL" "Linux-ISOs" "https://www.opensuse.org/" "OpenSUSE"	 

     !insertmacro SetISOFileNames "" "" "" "" "" "" ""
     !insertmacro SetISOFileNames "--- Tiny Distros ---" "" "" "" "" "" ""
     !insertmacro SetISOFileNames "" "" "" "" "" "" ""	
	 
 !insertmacro SetISOFileNames "Puppy Linux" "*pup*.iso" "https://puppylinux-woof-ce.github.io/index.html#download" "NULL" "Tiny-Distros" "https://puppylinux-woof-ce.github.io/index.html" "Puppy Linux" 	 
 !insertmacro SetISOFileNames "Vanilla dPup" "*pup*.iso" "https://vanilla-dpup.github.io/" "NULL" "Tiny-Distros" "https://vanilla-dpup.github.io/" "Vanilla dPup" 	 
 !insertmacro SetISOFileNames "Puppy Arcade" "slacko_arcade*.iso" "https://archive.org/download/Puppy_Linux_Puppy_Arcade/slacko_arcade.iso" "NULL" "Tiny-Distros" "" ""	
 !insertmacro SetISOFileNames "Slacko Puppy" "*slacko*.iso" "https://distro.ibiblio.org/puppylinux/puppy-slacko-7.0/" "NULL" "Tiny-Distros" "https://forum.puppylinux.com/viewtopic.php?t=192" "Slacko Puppy" 
 !insertmacro SetISOFileNames "SLAX (Tiny Slackware Based Distro)" "slax*.iso" "https://slax.org/download-slax.php?a=64bit&b=Slackware" "NULL" "Tiny-Distros" "https://slax.org" "SLAX"
 !insertmacro SetISOFileNames "Slitaz (Another Tiny Distro)" "slitaz*.iso" "https://www.slitaz.org/en/get/" "NULL" "Tiny-Distros" "https://www.slitaz.org" "SliTaZ"
 !insertmacro SetISOFileNames "TinyCore" "*Core*.iso" "http://tinycorelinux.net/downloads.html" "NULL" "Tiny-Distros" "http://tinycorelinux.net" "TinyCore"
 ...
 !insertmacro SetISOFileNames "Aerynos" "aeryn*.iso" "https://aerynos.com/download/" "NULL" "Linux-ISOs" "https://aerynos.com/" "Aerynos"  
 !insertmacro SetISOFileNames "AmogOS" "amog*.iso" "https://github.com/Amog-OS/AmogOS" "NULL" "Linux-ISOs" "https://github.com/Amog-OS/AmogOS" "AmogOS"
 ...
 !insertmacro SetISOFileNames "Archlinux" "archlinux*.iso" "http://mirrors.us.kernel.org/archlinux/iso/latest/" "NULL" "Linux-ISOs" "https://archlinux.org" "Archlinux"  
 ...
 !insertmacro SetISOFileNames "Fyde OS" "Fyde*.img" "https://fydeos.io/download/" "NULL" "Linux-ISOs" "https://fydeos.io/" "Fyde OS"
 !insertmacro SetISOFileNames "KDE Neon" "neon*.iso" "https://neon.kde.org/download" "casper" "Linux-ISOs" "https://neon.kde.org/" "KDE Neon"
 !insertmacro SetISOFileNames "KNOPPIX" "KNOPPIX*.iso" "https://www.knopper.net/knoppix-mirrors/index-en.html" "NULL" "Linux-ISOs" "https://knopper.net" "KNOPPIX"
 ...
 !insertmacro SetISOFileNames "Proxmox" "Proxmox*.iso" "https://www.proxmox.com/downloads" "NULL" "Linux-ISOs" "https://www.proxmox.com" "Proxmox" 
 ...
 !insertmacro SetISOFileNames "Raspberry Pi Desktop" "*ras*.iso" "https://www.raspberrypi.org/downloads/raspberry-pi-desktop/" "live" "Linux-ISOs" "https://www.raspberrypi.org/downloads/raspberry-pi-desktop/" "Raspberry Pi"
 ...
 !insertmacro SetISOFileNames "TrueNAS" "Truenas*.iso" "https://www.truenas.com/download-truenas-community-edition/" "NULL" "Linux-ISOs" "https://www.truenas.com/truenas-community-edition/" "TrueNAS"
 ...
 !insertmacro SetISOFileNames "VOID Linux" "void-live*.iso" "https://voidlinux.org/download/" "NULL" "Linux-ISOs" "https://voidlinux.org" "VOID Linux" 
 !insertmacro SetISOFileNames "Zorin OS" "zorin*.iso" "https://zorinos.com/download/" "casper" "Linux-ISOs" "https://zorin-os.com/" "Zorin OS"
  
     !insertmacro SetISOFileNames "" "" "" "" "" "" ""
     !insertmacro SetISOFileNames "--- Anonymous Browsers ---" "" "" "" "" "" ""
     !insertmacro SetISOFileNames "" "" "" "" "" "" ""
 
 !insertmacro SetISOFileNames "JustBrowsing" "justbrowsing64*.iso" "https://sourceforge.net/projects/justbrowsing/files/latest/download" "NULL" "Anonymous-Browsers" "https://sourceforge.net/projects/justbrowsing/" "JustBrowsing" 
 ...
 !insertmacro SetISOFileNames "Tails (Anonymous Browsing)" "tails*.img" "https://tails.net/install/download/index.en.html" "NULL" "Anonymous-Browsers" "https://tails.net/" "Tails"

     !insertmacro SetISOFileNames "" "" "" "" "" "" ""
     !insertmacro SetISOFileNames "--- Antivirus Tools ---" "" "" "" "" "" ""
     !insertmacro SetISOFileNames "" "" "" "" "" "" ""
	 
 !insertmacro SetISOFileNames "Antivirus Live CD (Virus Scanner)" "AntivirusLiveCD*.iso" "http://sourceforge.net/projects/antiviruslivecd/files/latest/download" "NULL" "AntiVirus-Utilities" "https://sourceforge.net/projects/antiviruslivecd/" "Antivirus Live CD"  
 ...
 !insertmacro SetISOFileNames "AVIRA AntiVir Rescue CD (Virus Scanner)" "*escue-system.iso" "https://www.avira.com/en/downloads#tab_a3_0" "NULL" "AntiVirus-Utilities" "https://www.avira.com/" "Avira"
 !insertmacro SetISOFileNames "Dr.Web LiveDisk" "drweb-livedisk*.iso" "https://download.geo.drweb.com/pub/drweb/livedisk/drweb-livedisk-900-cd.iso" "NULL" "AntiVirus-Utilities" "https://free.drweb.com/aid_admin/" "Dr.Web"  
 !insertmacro SetISOFileNames "Desinfec't 2013" "desinfect*.iso" "NONE" "NULL" "AntiVirus-Utilities" "" ""
 !insertmacro SetISOFileNames "ESET SysRescue Live" "eset*.iso" "https://www.eset.com/la/support/sysrescue/" "NULL" "AntiVirus-Utilities" "https://www.eset.com/la/support/sysrescue/" "ESET SysRecue Live" 
 !insertmacro SetISOFileNames "F-Secure Rescue CD" "rescue-cd*.iso" "https://download.f-secure.com/estore/rescue-cd-3.16-73600.iso" "NULL" "AntiVirus-Utilities" "https://www.f-secure.com/en_EMEA-Labs/security-threats/tools/rescue-cd/" "F-Secure Rescue CD"
 ...
 !insertmacro SetISOFileNames "Kaspersky Rescue Disk (Antivirus Scanner)" "krd.iso" "https://rescuedisk.s.kaspersky-labs.com/updatable/2018/krd.iso" "casper" "AntiVirus-Utilities" "https://support.kaspersky.com/viruses/rescuedisk" "Kaspersky"
 ...
 !insertmacro SetISOFileNames "Clonezilla (Backup + Clone Tool)" "clonezilla*.iso" "https://sourceforge.net/projects/clonezilla/files/latest/download" "live" "System-Tools" "https://clonezilla.org" "Clonezilla"
 ...
 !insertmacro SetISOFileNames "Ultimate Boot CD (Diagnostics Tools) - BIOS ONLY" "ubcd5*.iso" "https://www.ultimatebootcd.com/download.html" "NULL" "System-Tools" "https://www.ultimatebootcd.com" "Ultimate Boot CD"

     !insertmacro SetISOFileNames "" "" "" "" "" "" ""
     !insertmacro SetISOFileNames "--- Penetration Testing ---" "" "" "" "" "" ""
     !insertmacro SetISOFileNames "" "" "" "" "" "" ""
	
 !insertmacro SetISOFileNames "BackBox (Penetration Testing)" "backbox*.iso" "https://www.backbox.org/download/" "NULL" "Penetration-Testing" "https://linux.backbox.org/" "BackBox"
 !insertmacro SetISOFileNames "Caine (Penetration Testing)" "caine*.iso" "https://deb.parrot.sh/direct/parrot/iso/caine/caine12.4.iso" "NULL" "Penetration-Testing" "https://www.caine-live.net/" "Caine" 
 !insertmacro SetISOFileNames "Demon Linux (Penetration Testing)" "demon*.iso" "https://demonlinux.com/" "NULL" "Penetration-Testing" "https://demonlinux.com/" "Demon Linux"
 !insertmacro SetISOFileNames "Kali Linux (Penetration Testing)" "kali*live*.iso" "https://www.kali.org/get-kali/#kali-live" "casper" "Penetration-Testing" "https://www.kali.org" "Kali"
 !insertmacro SetISOFileNames "Matriux (Penetration Testing)" "Matriux*.iso" "https://sourceforge.net/projects/matriux/files/latest/download" "NULL" "Penetration-Testing" "https://sourceforge.net/projects/matriux/" "Matriux" 
 !insertmacro SetISOFileNames "Wifislax (Wireless Penetration Testing)" "wifislax*.iso" "https://www.wifislax.com/category/download/" "NULL" "Penetration-Testing" "https://www.wifislax.com/" "Wifislax"
 !insertmacro SetISOFileNames "Xiaopan (Penetration Testing)" "Xiaopan*.iso" "https://sourceforge.net/projects/xiaopanos/files/latest/download" "NULL" "Penetration-Testing" "https://sourceforge.net/projects/xiaopanos/" "Xiaopan" 	 
...
${If} $WINE != "WINE"
     !insertmacro SetISOFileNames "" "" "" "" "" "" ""
     !insertmacro SetISOFileNames "--- Run Phoenix LiteOS X-Lite builds from VHD ---" "" "" "" "" "" ""
     !insertmacro SetISOFileNames "" "" "" "" "" "" ""
	 
 !insertmacro SetISOFileNames "Phoenix LiteOS" "Phoenix*.iso" "https://windowsxlite.com/downloads/" "casper" "Windows-On-VHD" "https://windowsxlite.com/" "Phoenix LiteOS" 
 !insertmacro SetISOFileNames "Windows X-Lite" "Windows X-Lite*.iso" "https://windowsxlite.com/downloads/" "casper" "Windows-On-VHD" "https://windowsxlite.com/" "X-Lite" 
${EndIf}

     !insertmacro SetISOFileNames "" "" "" "" "" "" ""
     !insertmacro SetISOFileNames "--- Unlisted Bootable ISO/IMG files ---" "" "" "" "" "" ""
     !insertmacro SetISOFileNames "" "" "" "" "" "" "" 	

 !insertmacro SetISOFileNames "Try an Unlisted ISO/IMG" "*.iso;*.img" "NONE" "NULL" "Unlisted ISOs" "" ""  
FunctionEnd